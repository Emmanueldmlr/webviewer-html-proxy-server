...
// const { getHostPortSSL } = require('./utils/getHostPortSSL');
const { isURLAbsolute } =  require('./utils/isURLAbsolute');
// const { getProxyFailedPage } =  require('./utils/proxyFailedPage');

// // import raw from assets
// // @ts-ignore
// const debounceJS  = require('./assets/debounceJS.js');
// // @ts-ignore
// const shared = require('./assets/shared.js');
// // @ts-ignore
// const sendTextData =  require('./assets/getTextData.js');
// // @ts-ignore
// const blockNavigation = require('./assets/blockNavigation.js');
// // @ts-ignore
// const linkPreview = require('./assets/linkPreview.js');
// // @ts-ignore
// const blockNavigationStyle =  require('./assets/blockNavigation.css');
// // @ts-ignore
// const linkPreviewStyle = require('./assets/linkPreview.css');
...
// }) => {
  ...
  //   const cookiesHeaders = clientRequest.cookies.pdftron_proxy_headers;
  ...
  //           const headIndex = newBody.indexOf('</head>');
  //           if (headIndex > 0) {
  ...
  //         let cssContent = '';
  //         let externalResponse = serverResponse;
